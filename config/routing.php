...
$app->get('/blog/{page}', 'TitoMiguelCosta\Controller\Blog::listAction')->value('page', '1')->bind('blog_list');
...
$app->get('/photos/{page}', 'TitoMiguelCosta\Controller\Photo::listAction')->value('page', '1')->bind('photos');
